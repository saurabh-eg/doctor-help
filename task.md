...
## Mobile App Fixes
- [x] Investigate and fix text visibility issues across all screens <!-- id: 0 -->
- [x] Audit and fix UI truncation/layout issues <!-- id: 4 -->
    - [x] Fix Login screen "records" truncation
    - [x] Fix Role Select screen text wrapping
    - [x] Fix Verify OTP screen text wrapping
    - [x] Fix Patient Home screen text wrapping
    - [x] Fix Patient Search screen text wrapping  
    - [x] Fix Doctor Profile screen text wrapping
    - [x] Fix Patient Profile screen text wrapping
    - [x] Fix Doctor Dashboard screen text wrapping
    - [x] Fix Doctor Profile screen text wrapping
