...
abstract class $ApiResponseCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({bool success, T? data, String? error, String? message});
}
...
class _$ApiResponseImpl<T> implements _ApiResponse<T> {
  ...
  int get hashCode => Object.hash(runtimeType, success,
      const DeepCollectionEquality().hash(data), error, message);
...
class _$PaginatedResponseImpl<T> implements _PaginatedResponse<T> {
  ...
  @override
  String toString() {
    return 'PaginatedResponse<$T>(success: $success, data: $data, page: $page, limit: $limit, total: $total, hasMore: $hasMore, error: $error)';
  }
...
abstract class _PaginatedResponse<T> implements PaginatedResponse<T> {
  const factory _PaginatedResponse(
      ...
      final String? error}) = _$PaginatedResponseImpl<T>;
